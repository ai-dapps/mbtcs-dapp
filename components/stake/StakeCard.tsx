    ...
    <div className="mb-8 xs:mb-6 2xs:mb-6 p-8 xs:p-6 2xs:p-6 rounded-3xl bg-black bg-opacity-40 text-white">
      <div className="grid grid-cols-12 gap-8 xs:gap-6 2xs:gap-4">
        ...
        <div className="col-span-6 flex justify-between items-center text-3xl sm:text-2xl xs:text-base 2xs:text-xs">
          <div className="text-[#aba6ce] tracking-tighter">Hash Rate</div>
        ...
        {/* <button
          className="row-span-2 col-span-6 text-center text-[#aba6ce] border-[#aba6ce] border-[1px] rounded-2xl py-4 xs:py-3 2xs:py-3 mt-2 text-4xl sm:text-3xl xs:text-lg 2xs:text-sm"
          onClick={(e) => onHarverst(e, token)}
        >
          Harvest
        </button> */}
        <button
